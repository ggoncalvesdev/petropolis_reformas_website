                        ...
                        return (function (a) {
                                                ...
                                                (c = [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        value: function () {
                                                            ...
                                                            (this._targetState = g({}, u, {}, this._targetState)),
                                                                (this._easing = t(u, j));
                                                            var v = a.filters;
                            ...
                            function (a, b, c) {
                                ...
                                var d = function (a) {
                                    ...
                                    D = function (a) {
                                        return (
                                            -1 * Math.pow(4, -8 * a) * Math.sin(((6 * a - 1) * (2 * Math.PI)) / 2) + 1
                                        );
                                    },
                                    E = function (a) {
                                        var b = 1.70158;
                            ...
                            function (a, b, c) {
                                ...
                                var p,
                                    ...
                                    v =
                                        ...
                                        (q = /,\s*/.source),
                                        new RegExp(
                                            "rgb\\(".concat(p).concat(q).concat(p).concat(q).concat(p, "\\)"),
                                            "g"
                                        )),
                                    w = /^.*\(/,
                                    x = /#([0-9]|[a-f]){3,6}/gi,
                                    ...
                                    z = function (a) {
                                        return "rgb(".concat(
                                            ...
                                            3 === (b = b.replace(/#/, "")).length &&
                                                (b = (b = b.split(""))[0] + b[0] + b[1] + b[1] + b[2] + b[2]),
                                            ...
                                            "string" == typeof f &&
                                                (d[e] = {
                                                    formatString:
                                                        ...
                                                        (c = b.match(t)),
                                                        c
                                                            ? (1 === c.length || b.charAt(0).match(s)) && c.unshift("")
                                                            : (c = ["", ""]),
                                                        c.join("VAL")),
                                                    chunkNames: y(D(f), e),
                                                });
